...
└── pycdscriptor/
    ...
    │   ├── dotcfg.py
    │   └── glbda.py           # Cầu nối context["task_tsm"/"task_fsm"] với khối glbda: của μE-LS
